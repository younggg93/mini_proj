...
<div class="w3-container"> 
  ...
  <button type="button" onclick="location.href='drink.html'">수정</button>
  <button type="button" onclick="location.href='drink.html'">삭제</button>
  <br><br>
  <p align="left">
  <button type="button"  onclick="location.href='../Drink/drink.html'">목록으로</button>
  </p>
  <p align="right">
  <button type="button"  onclick="location.href='../Drink/drink.html'">수정</button>
  <button type="button" onclick="location.href='../Drink/drink.html'">삭제</button>
  </p></div>
  </div>
  </div>  
</body>
