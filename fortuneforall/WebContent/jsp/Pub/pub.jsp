<%@page import="com.fortuneforall.pub.domain.Pub"%>
...
<nav class="navbar navbar-inverse">
  ...
  <div class="panel-heading" align="center">술집 후기 게시판</div>
  <div class="panel-body">
  	<div class="container">
  <p>술집에 대한 후기를 작성하는 게시판입니다
  <%--
  for(int i=0;i<list.size();i++) {
	  Drink d = list.get(i);
	  System.out.println(d.getBoard_no());
  }
  --%></p>            
  <table class="table table-hover">
    ...
    <tbody>
      <tr>
        <td><a href="../html/common/board.jsp">2</a></td>
        <td><a href="../html/common/board.jsp">소시지빵</a></td>
        <td><a href="../html/common/board.jsp">마니또</a></td>
        <td><a href="../html/common/board.jsp">2017-08-24</a></td>
      </tr>
    </tbody>
  </table>
   <form>
